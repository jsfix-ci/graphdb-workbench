...
+function (t) {
    ...
    e.VERSION = "3.3.7", e.TRANSITION_DURATION = 150, e.DEFAULTS = {
        ...
        var u = /top|bottom/.test(o), c = u ? 2 * l.left - i + p : 2 * l.top - r + h, f = u ? "offsetWidth" : "offsetHeight";
        ...
        return o.prototype.addSteps = function (t) {
            ...
            for (s = t(e).height(), c = t(e).width(), u = [], a = 0, p = (l = ["top", "bottom", "left", "right"]).length; a < p; a++) switch (h = l[a], i = null != (r = this.backdrops)[h] ? r[h] : r[h] = t("<div>", {class: "tour-backdrop " + h}), t(o.backdropContainer).append(i), h) {
                case"top":
                    ...
                    break;
                case"bottom":
                    u.push(i.offset({top: n.offset.top + n.height, left: 0}).height(s - (n.offset.top + n.height)).width(c));
                    break;
                case"left":
                    u.push(i.offset({top: n.offset.top, left: 0}).height(n.height).width(n.offset.left > 0 ? n.offset.left : 0));
                    break;
                case"right":
                    u.push(i.offset({
                        top: n.offset.top,
